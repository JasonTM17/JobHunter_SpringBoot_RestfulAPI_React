...
export default function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex w-full max-w-[1120px] items-center justify-between gap-2 px-3 py-2.5 sm:px-4 lg:px-4">
      ...
      <div className="mx-auto w-full max-w-[1120px] px-3 pb-2 sm:px-4 lg:hidden">
