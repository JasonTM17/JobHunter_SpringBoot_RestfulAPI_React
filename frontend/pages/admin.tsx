        ...
        actions={
          <>
            ...
            <button
              ...
              className="rounded-md border border-white/20 bg-white/10 px-4 py-2 text-sm font-semibold text-slate-100 hover:bg-white/20"
            >
              Làm mới số liệu
            </button>
          </>
      ...
      <section className="mt-4 grid items-start gap-4 md:grid-cols-[minmax(0,1.05fr)_0.95fr]">
        <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-soft sm:p-6">
          ...
          <div className="mt-4 grid gap-2">
            <Link
              href="/?tab=manage&module=users"
              className="rounded-md bg-slate-900 px-4 py-2.5 text-center text-sm font-semibold text-white hover:bg-slate-800"
            >
              Mở cổng quản trị chi tiết
            </Link>
            <Link
