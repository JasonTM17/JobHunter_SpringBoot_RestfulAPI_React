    ...
    <>
      ...
      <section className="mt-4 grid items-start gap-4 lg:grid-cols-[minmax(0,1.3fr)_360px]">
          ...
          {latestResumes.length === 0 ? (
            ...
            <div className="mt-4 grid gap-2.5">
              {latestResumes.slice(0, 8).map((resume) => (
                <article key={resume.id} className="rounded-lg border border-slate-200 bg-slate-50 p-3.5">
        ...
        <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-soft sm:p-6">
          ...
          <div className="mt-4 grid gap-2.5">
            <article className="flex items-start gap-3 rounded-lg border border-slate-200 bg-slate-50 p-3.5">
            ...
            <article className="flex items-start gap-3 rounded-lg border border-slate-200 bg-slate-50 p-3.5">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-emerald-100">
            ...
            <article className="flex items-start gap-3 rounded-lg border border-slate-200 bg-slate-50 p-3.5">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-sky-100">
