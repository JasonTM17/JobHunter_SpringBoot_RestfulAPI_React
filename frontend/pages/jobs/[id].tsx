          ...
          <div className="min-w-0">
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-2 text-sm font-semibold text-slate-200">{companyName}</p>
          ...
          <section className="rounded-3xl border border-rose-200 bg-gradient-to-b from-white to-rose-50/60 p-4 shadow-soft">
            ...
            <div className="mt-4 grid gap-2.5">
              <Link
                ...
                className="rounded-xl bg-rose-600 px-3 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-rose-700"
              >
